  ...
  async getPaymentStages(projectId: number): Promise<any[]> {
    try {
      const stages = await db
        .select({
          id: paymentStages.id,
          projectId: paymentStages.projectId,
          stageName: paymentStages.stageName,
          stagePercentage: paymentStages.stagePercentage,
          amount: paymentStages.amount,
          requiredProgress: paymentStages.requiredProgress,
          status: paymentStages.status,
          paymentLink: paymentStages.paymentLink,
          paymentMethod: paymentStages.paymentMethod,
          paymentData: paymentStages.paymentData,
          proofFileUrl: paymentStages.proofFileUrl,
          whatsappNotificationSent: paymentStages.whatsappNotificationSent,
          paidAt: paymentStages.paidAt,
          createdAt: paymentStages.createdAt,
          updatedAt: paymentStages.updatedAt
        })
        .from(paymentStages)
